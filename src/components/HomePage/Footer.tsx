    ...
    <footer class="lg:text-left mt-14 text-gray-600">
      <div class="flex justify-center items-center lg:justify-between p-6 border-y border-gray-300">
        ...
        <div class="flex justify-center">
          ...
          <a href="https://twitter.com/dare2solve" class="mr-6 text-gray-600">
            <svg
              aria-hidden="true"
              data-prefix="fab"
              data-icon="twitter"
          ...
          <a href="https://in.pinterest.com/dare2solve/" class="text-gray-600">
            <svg
              aria-hidden="true"
              data-prefix="fab"
              data-icon="pinterest"
      ...
      <div class="mx-6 py-10 text-center md:text-left">
        <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <h6 class="flex items-center justify-center md:justify-start mb-4">
              <svg
                aria-hidden="true"
                data-prefix="fas"
                data-icon="home"
            ...
            <h6 class="flex items-center justify-center md:justify-start mb-8">
              <svg
                aria-hidden="true"
                data-prefix="fas"
                data-icon="envelope"
