const terms = () => {
  return (
    <div class="max-w-2xl mx-auto text-justify py-4">
      <h2>
        <strong>Terms and Conditions</strong>
      </h2>

      <p>Welcome to AuthorsLog!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of AuthorsLog's Website, located at
        https://solid-full-stack.vercel.app/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use AuthorsLog if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing AuthorsLog, you agreed to use
        cookies in agreement with the AuthorsLog's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, AuthorsLog and/or its licensors own the
        intellectual property rights for all material on AuthorsLog. All
        intellectual property rights are reserved. You may access this from
        AuthorsLog for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from AuthorsLog</li>
        <li>Sell, rent or sub-license material from AuthorsLog</li>
        <li>Reproduce, duplicate or copy material from AuthorsLog</li>
        <li>Redistribute content from AuthorsLog</li>
      </ul>
      ...
      <p>
        ...
        AuthorsLog does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of AuthorsLog,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, AuthorsLog shall not be
      ...
      <p>
        AuthorsLog reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant AuthorsLog a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of AuthorsLog; and (d) the link is
      ...
      <p>
        ...
        e-mail to AuthorsLog. Please include your name, your organization name,
      ...
      <p>
        No use of AuthorsLog's logo or other artwork will be allowed for linking
