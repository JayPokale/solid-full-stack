const privacy = () => {
  return (
    <div class="max-w-2xl mx-auto text-justify py-4">
      <h1>
        <strong>Privacy Policy for AuthorsLog</strong>
      </h1>

      <p>
        At AuthorsLog, accessible from https://solid-full-stack.vercel.app/, one
        of our main priorities is the privacy of our visitors. This Privacy
        Policy document contains types of information that is collected and
        recorded by AuthorsLog and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in AuthorsLog. This policy is not applicable to
      ...
      <p>
        AuthorsLog follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, AuthorsLog uses "cookies". These cookies are
      ...
      <p>
        ...
        advertising partners of AuthorsLog.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on AuthorsLog, which are sent
      ...
      <p>
        Note that AuthorsLog has no access to or control over these cookies that
      ...
      <p>
        AuthorsLog's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        AuthorsLog does not knowingly collect any Personal Identifiable
